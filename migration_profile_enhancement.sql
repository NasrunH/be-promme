...
-- Hapus default value terlebih dahulu jika ada
ALTER TABLE public.creators ALTER COLUMN jenis_kelamin DROP DEFAULT IF EXISTS;
-- Ubah tipe kolom
...
-- Hapus default value terlebih dahulu jika ada
ALTER TABLE public.brands ALTER COLUMN ukuran_perusahaan DROP DEFAULT IF EXISTS;
-- Ubah tipe kolom
...
-- Hapus default value terlebih dahulu jika ada
ALTER TABLE public.brands ALTER COLUMN industri DROP DEFAULT IF EXISTS;
-- Ubah tipe kolom
...
-- Hapus default value terlebih dahulu jika ada
ALTER TABLE public.creators ALTER COLUMN kategori_niche DROP DEFAULT IF EXISTS;
-- Ubah tipe kolom
